...
namespace ImportData.IntegrationServicesClient.Models
{
  ...
  public class IRegistrationGroups : IRecipients
  {
    ...
    {
      var name = propertiesForSearch.ContainsKey(Constants.KeyAttributes.RegistrationGroup) ?
       propertiesForSearch[Constants.KeyAttributes.RegistrationGroup] : propertiesForSearch[Constants.KeyAttributes.Name];
