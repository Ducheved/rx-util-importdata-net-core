...
namespace ImportData.IntegrationServicesClient.Models
{
    public class IEntity
    {
        ...
        public static IEntity FindEntity(Dictionary<string, string> propertiesForSearch, Entity entity, bool isEntityForUpdate, List<Structures.ExceptionsStruct> exceptionList, NLog.Logger logger)
        {
            return null;
        }
