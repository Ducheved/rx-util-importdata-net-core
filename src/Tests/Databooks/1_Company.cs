  ...
  public partial class Tests
  {
    ...
    public static string EqualsEmployee(List<string> parameters, int shift = 0)
    {
      ...
      var errorList = new List<string>
      {
        ...
        Common.CheckParam(actualEmployee.JobTitle != null ? actualEmployee.JobTitle.Name : string.Empty, parameters[shift + 2], "JobTitle"),
        ...
        Common.CheckParam(actualPerson.City != null ? actualPerson.City.Name : string.Empty, parameters[shift + 10], "City"),
        Common.CheckParam(actualPerson.Region != null ? actualPerson.Region.Name : string.Empty, parameters[shift + 11], "Region"),
      ...
      var errorList = new List<string>
            {
                ...
                Common.CheckParam(actualBusinessUnit.City != null ? actualBusinessUnit.City.Name : string.Empty, parameters[shift + 10], "City"),
                Common.CheckParam(actualBusinessUnit.Region != null ? actualBusinessUnit.Region.Name : string.Empty, parameters[shift + 11], "Region"),
